...
function CategoryRow({ category, selected, onClick, onReload }: {
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center justify-between px-3 py-2 rounded-lg border transition-colors ${selected ? 'border-blue-600 bg-blue-950/30' : 'border-gray-800 hover:border-gray-600'} ${onClick ? 'cursor-pointer' : ''}`}
    >
